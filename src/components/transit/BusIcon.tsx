...
/**
 * Paris Bus pictogram (rectangle + lettres BUS).
 * Converted from Wikimedia Commons: Paris_transit_icons_-_Bus.svg
 * License: PD-textlogo (public domain)
 */
export function BusIcon({ size = 14, color = '#25303B' }: BusIconProps) {
  return (
