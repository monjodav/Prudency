...
/**
 * Paris Metro pictogram (cercle + M).
 * Converted from Wikimedia Commons: Paris_transit_icons_-_Métro.svg
 * License: PD-textlogo (public domain)
 */
export function MetroIcon({ size = 14, color = '#25303B' }: MetroIconProps) {
  return (
